...
\author[ECON 5001]{ECON 5001\\Prof. Healy\\Based on: \textit{Game Theory} by Giacomo Bonanno} \color{metrop}
\institute[OSU]{}
...
\vfill
{\scriptsize This ``money pump'' argument is not in the text, but is standard.}
\end{frame}
...
\textbf{Story A.} Both would rather be together; Alex wants donuts, Blair wants
chicken \& waffles.
\bsk
\begin{itemize}
...
\bsk
Ask: how do $a$ and $b$ compare \textbf{in every situation they might face}?
\bsk
\begin{itemize}
...
\bsk
\begin{itemize}
    \item $s_i$ is a \textbf{strictly dominant strategy} if $s_i$ strictly dominates
...
\end{itemize}
\vfill
Two consequences, one at a time:
\begin{itemize}
