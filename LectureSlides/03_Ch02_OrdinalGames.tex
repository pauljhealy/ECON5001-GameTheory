...
\centering
\large
What you're about to play is the most studied game in the field:\\
\bsk
...
\begin{itemize}
    ...
    \item Class code: \hspace{0.1in} \texttt{\underline{\hspace{1.3in}}}
    \item One decision: \textbf{Split} or \textbf{Steal}
\end{itemize}
\bsk
No talking, no signaling. Choose what you'd actually choose.
\vfill
\centering
{\footnotesize Trouble getting in? Flag me, or email \texttt{support@moblab.com}.}
\vspace{-0.3in}
\end{frame}
...
\begin{frame}{Three Carts at the North Market}
Ann, Ben, and Cal each run a cart. Every Saturday each one independently picks
